...
const About = () => {
  return (
      ...
      >
        <motion.h2 variants={itemVariants} className="text-4xl font-bold mb-4 text-blue-600 dark:text-cyan-400">
          About Me
        </motion.h2>
        <motion.p className="text-lg md:text-xl mb-6 leading-relaxed text-gray-700 dark:text-gray-300">
